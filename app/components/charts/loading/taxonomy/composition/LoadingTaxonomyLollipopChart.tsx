import { COMPOSITION_LOLLIPOP_DEFAULT_RANK } from "../../../wrappers/TaxonomyVisualize";
import LoadingChartCopyButton from "../../LoadingChartCopyButton";
import LoadingChart from "../../LoadingChart";

export default function LoadingTaxonomyLollipopChart() {
	return (
			...
			<div className="w-full flex justify-center items-center gap-5 mb-4">
				<fieldset className="fieldset">
					...
					<select className="select" disabled>
						<option>{COMPOSITION_LOLLIPOP_DEFAULT_RANK}</option>
					</select>
				</fieldset>
