import { PREVALENCE_DEFAULT_RANK } from "../../wrappers/TaxonomyVisualize";
import LoadingChartCopyButton from "../LoadingChartCopyButton";
import LoadingChart from "../LoadingChart";

export default function LoadingTaxaPrevalenceHistogram() {
	return (
			...
			<div className="w-full flex justify-center items-end gap-5 mb-4">
				<fieldset className="fieldset">
					...
					<select className="select" disabled>
						<option>{PREVALENCE_DEFAULT_RANK}</option>
					</select>
				</fieldset>
