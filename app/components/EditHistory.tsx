...
export default async function EditHistory({ editHistory }: { editHistory: PrismaJson.EditHistoryType | null }) {
	return (
		<div className="dropdown dropdown-hover ml-1">
			...
			<ul
				tabIndex={-1}
				className="dropdown-content bg-base-200 rounded-box p-4 sm:p-6 shadow-sm max-h-[400px] w-[min(36rem,calc(100vw-1rem))] max-w-[calc(100vw-1rem)] overflow-y-auto overflow-x-auto overscroll-contain"
			>
