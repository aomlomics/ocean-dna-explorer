...
const SampleViz: React.FC<SampleVizProps> = ({ onNext, onBack }) => {
	const handleMagnifyingGlassClick = (e: React.MouseEvent) => {
		e.preventDefault();
		e.stopPropagation();
		console.log("Sample magnifying glass clicked - going to bioinfo");
		onNext();
	};
		...
		<div className="relative w-full h-full overflow-hidden">
			...
			<div className="absolute inset-0 flex items-center justify-center z-30 mb-4">
				<div className="text-primary">
					<svg viewBox="0 0 215.27 892.2" className="w-[2.8rem] max-w-[8vw] max-h-[14%] h-auto rotate-20" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
