...
export default function TourForm() {
	...
	async function generateTourSteps({
		...
		setTourSteps([
			...
			{ url: "/learn/edna101#learn" },
			{ url: "/learn/edna101#step1" },
			{ url: "/learn/edna101#step2" },
			{ url: "/learn/edna101#step3" },
			{ url: "/learn/edna101#step4" },
			{ url: "/learn/edna101#step5" },
			{ url: "/learn/edna101#step6" },
			{ url: "/learn/edna101#step7" },
			{ url: "/learn/edna101#step8" },
			{ url: "/learn/edna101#step9" },
			{ url: "/learn/edna101#step10" },
			{ url: "/learn/edna101#step11" },
			{ url: "/learn/impact#learn" },
			{ url: "/learn/impact#step1" },
			{ url: "/learn/impact#step2" },
			{ url: "/learn/impact#step3" },
			{ url: "/learn/impact#step4" },
			{ url: "/learn/impact#step5" },
			{ url: "/about#mission" },
			{ url: "/about#team" },
