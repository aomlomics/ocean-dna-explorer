...
export default function AboutPage() {
	return (
		<UnderConstruction message="The About page is under construction and will be available soon."/>
		// <main className="min-h-screen bg-base-100 text-base-content">
		// 	{/* Mission banner */}
		// 	<section className="relative -mt-6 sm:-mt-8 lg:-mt-10 -mx-4 sm:-mx-6 lg:-mx-8 xl:-mx-16 mb-12">
		// 		<div className="relative h-[260px] sm:h-[320px] md:h-[380px] lg:h-[440px] overflow-hidden rounded-b-[2.5rem] bg-slate-900">
		// 			<Image
		...
		// 			<div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center text-base-100">
		// 				<span className="mb-4 inline-flex items-center rounded-full bg-base-100/10 px-3 py-1 text-xs font-semibold tracking-[0.25em] uppercase text-base-100/80">
		// 					Ocean DNA Explorer
		// 				</span>
		// 				<h1 className="mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold drop-shadow-md">
		// 					Our Mission
		// 				</h1>
