...
const OceanGlobe = dynamic(() => import("@/app/components/OceanGlobe"), {
	ssr: false,
	loading: () => (
		<div className="aspect-square w-full max-w-md mx-auto bg-base-200/50 rounded-full animate-pulse" />
	)
});
...
export default function LearnPage() {
	...
	return (
		<main className="min-h-screen bg-base-100 text-base-content">
			{/* Page Header */}
			<section className="relative -mt-6 sm:-mt-8 lg:-mt-10 left-1/2 right-1/2 -mx-[50vw] w-screen mb-4 sm:mb-6 pointer-events-none">
				<div className="px-4 pt-12 sm:pt-16 md:pt-20 pb-4 text-center pointer-events-auto">
					<h1 className="mb-4 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-primary">Learn</h1>
			...
			<section className="relative z-0 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-16 sm:pb-20 space-y-24 sm:space-y-28">
				{/* The Data Journey */}
				<section className="space-y-20 lg:space-y-28">
					...
					{/* Step 6: Taxonomy & Assignment — Identification */}
					<div className="space-y-10">
						<div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
							<div className="relative w-full h-[280px] sm:h-[360px] lg:h-[440px]">
							...
							<div className="space-y-3 text-center lg:text-left">
								<h3 className="text-2xl lg:text-3xl font-semibold text-primary">Taxonomy &amp; Assignment</h3>
								<p className="text-base lg:text-lg text-base-content/85 leading-relaxed">
									The final step is identification. We compare our Features against global reference databases. Taxonomy stores the scientific names, and Assignment records our confidence—telling users exactly how sure we are of each species&apos; identity.
								</p>
							</div>
						</div>
					</div>

					{/* Step 7: Occurrence — Global Distribution */}
					<div className="space-y-10">
						<div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
							<div className="w-full max-w-md mx-auto lg:max-w-none order-2 lg:order-1">
								<OceanGlobe className="max-w-sm mx-auto lg:max-w-md" />
							</div>
							<div className="space-y-3 text-center lg:text-left order-1 lg:order-2">
								<h3 className="text-2xl lg:text-3xl font-semibold text-primary">Occurrence</h3>
								<p className="text-base lg:text-lg text-base-content/85 leading-relaxed">
									{TableMetadata.occurrence.description} Each marker on the globe represents sampling locations across the world&apos;s oceans where eDNA reveals the presence and distribution of marine life.
								</p>
							</div>
						</div>
					</div>
