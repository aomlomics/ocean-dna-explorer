...
export const SampleSchema = z.object({
  ...
  date_ext__TEMP: z.coerce.date().nullish(),
...
export const SampleOptionalDefaultsSchema = SampleSchema.merge(z.object({
  id: z.number().int().optional(),
  eventDate__TEMP: z.coerce.date().optional(),
}))
...
export const AssaySchema = z.object({
  ...
  ampliconSize__TEMP: z.number().nullish(),
