...
export const AnalysisSchema = z.object({
  ...
  isPrivate: z.union([z.boolean(), z.literal("true"), z.literal("false")]).transform((value) => value === true || value === "true"),
  /**
   * [EditHistoryType]
   */
