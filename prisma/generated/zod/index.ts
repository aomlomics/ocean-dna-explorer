...
export type NullableJsonInput =
	...
	| "JsonNull"
	| "DbNull"
	| typeof Prisma.NullTypes.DbNull
	| typeof Prisma.NullTypes.JsonNull;
...
export const AnalysisScalarFieldEnumSchema = z.enum([
	...
	"analysisMetadataFileChecksum_ODE",
	"asvFileUrl_ODE",
	"asvFileChecksum_ODE",
	...
	"blca_confidence",
	"percent_match",
	"percent_match_Midpoint_ODE",
	"percent_match_End_ODE",
	"percent_query_cover",
	"percent_query_cover_Midpoint_ODE",
	"percent_query_cover_End_ODE"
]);
...
export const AlphaDiversityScalarFieldEnumSchema = z.enum([
	"id",
	"dateCalculated",
	"analysis_run_name",
	"indexType",
...
export const ProjectScalarFieldEnumSchema = z.enum([
	...
	"projectMetadataFileChecksum_ODE",
...
export const AssayPrepScalarFieldEnumSchema = z.enum([
	"id",
	"project_id",
	"assay_name",
	"thermocycler",
...
export const TaxonomyOrderByRelevanceFieldEnumSchema = z.enum([
	"taxonomy",
	"verbatimIdentification",
	"domain",
	"kingdom",
...
export const SampleOrderByRelevanceFieldEnumSchema = z.enum([
	"samp_name",
	"biosample_accession",
	"project_id",
	"samp_category",
...
export const AssayOrderByRelevanceFieldEnumSchema = z.enum([
	"assay_name",
	"pcr_primer_forward",
	"pcr_primer_reverse",
	"pcr_primer_name_forward",
...
export const AssayPrepOrderByRelevanceFieldEnumSchema = z.enum([
	"project_id",
	"assay_name",
	"thermocycler",
	"commercial_mm",
...
export const LibraryOrderByRelevanceFieldEnumSchema = z.enum([
	"lib_id",
	"project_id",
	"samp_name",
	"assay_name",
...
export const DeadBooleanSchema = z.enum([
	...
	"not_provided",
	"restricted_access",
	"missingCOLON__control_sample",
	"missingCOLON__sample_group",
	"missingCOLON__synthetic_construct",
	"missingCOLON__lab_stock",
	"missingCOLON__third_party_data",
	"missingCOLON__data_agreement_established_pre__2023",
	"missingCOLON__endangered_species",
	"missingCOLON__human__identifiable"
]);
...
export const AnalysisWithRelationsSchema: z.ZodType<AnalysisWithRelations> = AnalysisSchema.merge(
	z.object({
...
export type AnalysisOptionalDefaultsWithRelations = Omit<
	z.infer<typeof AnalysisOptionalDefaultsSchema>,
	"editHistory"
> & {
	editHistory?: JsonValueType | null;
} & AnalysisOptionalDefaultsRelations;

export const AnalysisOptionalDefaultsWithRelationsSchema: z.ZodType<AnalysisOptionalDefaultsWithRelations> =
	AnalysisOptionalDefaultsSchema.merge(
		z.object({
...
export const AnalysisPartialWithRelationsSchema: z.ZodType<AnalysisPartialWithRelations> = AnalysisPartialSchema.merge(
	z.object({
...
export type AnalysisOptionalDefaultsWithPartialRelations = Omit<
	z.infer<typeof AnalysisOptionalDefaultsSchema>,
	"editHistory"
> & {
	editHistory?: JsonValueType | null;
...
export const AnalysisOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AnalysisOptionalDefaultsWithPartialRelations> =
	AnalysisOptionalDefaultsSchema.merge(
		z
			.object({
				Project: z.lazy(() => ProjectPartialWithRelationsSchema),
...
export const AnalysisWithPartialRelationsSchema: z.ZodType<AnalysisWithPartialRelations> = AnalysisSchema.merge(
	z
		.object({
			Project: z.lazy(() => ProjectPartialWithRelationsSchema),
			Assay: z.lazy(() => AssayPartialWithRelationsSchema),
...
export const OccurrenceWithRelationsSchema: z.ZodType<OccurrenceWithRelations> = OccurrenceSchema.merge(
	z.object({
...
export type OccurrenceOptionalDefaultsWithRelations = z.infer<typeof OccurrenceOptionalDefaultsSchema> &
	OccurrenceOptionalDefaultsRelations;

export const OccurrenceOptionalDefaultsWithRelationsSchema: z.ZodType<OccurrenceOptionalDefaultsWithRelations> =
	OccurrenceOptionalDefaultsSchema.merge(
		z.object({
...
export const OccurrencePartialWithRelationsSchema: z.ZodType<OccurrencePartialWithRelations> =
	OccurrencePartialSchema.merge(
		z.object({
...
export type OccurrenceOptionalDefaultsWithPartialRelations = z.infer<typeof OccurrenceOptionalDefaultsSchema> &
	OccurrencePartialRelations;

export const OccurrenceOptionalDefaultsWithPartialRelationsSchema: z.ZodType<OccurrenceOptionalDefaultsWithPartialRelations> =
	OccurrenceOptionalDefaultsSchema.merge(
		z
			.object({
				Library: z.lazy(() => LibraryPartialWithRelationsSchema),
...
export const OccurrenceWithPartialRelationsSchema: z.ZodType<OccurrenceWithPartialRelations> = OccurrenceSchema.merge(
	z
		.object({
			Library: z.lazy(() => LibraryPartialWithRelationsSchema),
			Analysis: z.lazy(() => AnalysisPartialWithRelationsSchema),
...
export const AssignmentWithRelationsSchema: z.ZodType<AssignmentWithRelations> = AssignmentSchema.merge(
	z.object({
		Analysis: z.lazy(() => AnalysisWithRelationsSchema),
		Feature: z.lazy(() => FeatureWithRelationsSchema),
...
export type AssignmentOptionalDefaultsWithRelations = z.infer<typeof AssignmentOptionalDefaultsSchema> &
	AssignmentOptionalDefaultsRelations;

export const AssignmentOptionalDefaultsWithRelationsSchema: z.ZodType<AssignmentOptionalDefaultsWithRelations> =
	AssignmentOptionalDefaultsSchema.merge(
		z.object({
			Analysis: z.lazy(() => AnalysisOptionalDefaultsWithRelationsSchema),
			Feature: z.lazy(() => FeatureOptionalDefaultsWithRelationsSchema),
...
export const AssignmentPartialWithRelationsSchema: z.ZodType<AssignmentPartialWithRelations> =
	AssignmentPartialSchema.merge(
		z.object({
			Analysis: z.lazy(() => AnalysisPartialWithRelationsSchema),
			Feature: z.lazy(() => FeaturePartialWithRelationsSchema),
...
export type AssignmentOptionalDefaultsWithPartialRelations = z.infer<typeof AssignmentOptionalDefaultsSchema> &
	AssignmentPartialRelations;

export const AssignmentOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AssignmentOptionalDefaultsWithPartialRelations> =
	AssignmentOptionalDefaultsSchema.merge(
		z
			.object({
				Analysis: z.lazy(() => AnalysisPartialWithRelationsSchema),
...
export const AssignmentWithPartialRelationsSchema: z.ZodType<AssignmentWithPartialRelations> = AssignmentSchema.merge(
	z
		.object({
			Analysis: z.lazy(() => AnalysisPartialWithRelationsSchema),
			Feature: z.lazy(() => FeaturePartialWithRelationsSchema),
...
export const FeatureWithRelationsSchema: z.ZodType<FeatureWithRelations> = FeatureSchema.merge(
	z.object({
		Occurrences: z.lazy(() => OccurrenceWithRelationsSchema).array(),
		Assignments: z.lazy(() => AssignmentWithRelationsSchema).array()
	})
...
export type FeatureOptionalDefaultsWithRelations = z.infer<typeof FeatureOptionalDefaultsSchema> &
	FeatureOptionalDefaultsRelations;

export const FeatureOptionalDefaultsWithRelationsSchema: z.ZodType<FeatureOptionalDefaultsWithRelations> =
	FeatureOptionalDefaultsSchema.merge(
		z.object({
			Occurrences: z.lazy(() => OccurrenceOptionalDefaultsWithRelationsSchema).array(),
			Assignments: z.lazy(() => AssignmentOptionalDefaultsWithRelationsSchema).array()
		})
...
export const FeaturePartialWithRelationsSchema: z.ZodType<FeaturePartialWithRelations> = FeaturePartialSchema.merge(
	z.object({
		Occurrences: z.lazy(() => OccurrencePartialWithRelationsSchema).array(),
		Assignments: z.lazy(() => AssignmentPartialWithRelationsSchema).array()
	})
...
export type FeatureOptionalDefaultsWithPartialRelations = z.infer<typeof FeatureOptionalDefaultsSchema> &
	FeaturePartialRelations;

export const FeatureOptionalDefaultsWithPartialRelationsSchema: z.ZodType<FeatureOptionalDefaultsWithPartialRelations> =
	FeatureOptionalDefaultsSchema.merge(
		z
			.object({
				Occurrences: z.lazy(() => OccurrencePartialWithRelationsSchema).array(),
...
export const FeatureWithPartialRelationsSchema: z.ZodType<FeatureWithPartialRelations> = FeatureSchema.merge(
	z
		.object({
			Occurrences: z.lazy(() => OccurrencePartialWithRelationsSchema).array(),
			Assignments: z.lazy(() => AssignmentPartialWithRelationsSchema).array()
...
export const TaxonomyWithRelationsSchema: z.ZodType<TaxonomyWithRelations> = TaxonomySchema.merge(
	z.object({
		Assignments: z.lazy(() => AssignmentWithRelationsSchema).array()
	})
);
...
export type TaxonomyOptionalDefaultsWithRelations = z.infer<typeof TaxonomyOptionalDefaultsSchema> &
	TaxonomyOptionalDefaultsRelations;

export const TaxonomyOptionalDefaultsWithRelationsSchema: z.ZodType<TaxonomyOptionalDefaultsWithRelations> =
	TaxonomyOptionalDefaultsSchema.merge(
		z.object({
			Assignments: z.lazy(() => AssignmentOptionalDefaultsWithRelationsSchema).array()
		})
	);
...
export const TaxonomyPartialWithRelationsSchema: z.ZodType<TaxonomyPartialWithRelations> = TaxonomyPartialSchema.merge(
	z.object({
		Assignments: z.lazy(() => AssignmentPartialWithRelationsSchema).array()
	})
).partial();

export type TaxonomyOptionalDefaultsWithPartialRelations = z.infer<typeof TaxonomyOptionalDefaultsSchema> &
	TaxonomyPartialRelations;

export const TaxonomyOptionalDefaultsWithPartialRelationsSchema: z.ZodType<TaxonomyOptionalDefaultsWithPartialRelations> =
	TaxonomyOptionalDefaultsSchema.merge(
		z
			.object({
				Assignments: z.lazy(() => AssignmentPartialWithRelationsSchema).array()
...
export const TaxonomyWithPartialRelationsSchema: z.ZodType<TaxonomyWithPartialRelations> = TaxonomySchema.merge(
	z
		.object({
			Assignments: z.lazy(() => AssignmentPartialWithRelationsSchema).array()
		})
...
export const TagPartialWithRelationsSchema: z.ZodType<TagPartialWithRelations> = TagPartialSchema.merge(
	z.object({
...
export const TagWithPartialRelationsSchema: z.ZodType<TagWithPartialRelations> = TagSchema.merge(
	z
		.object({
			Analyses: z.lazy(() => AnalysisPartialWithRelationsSchema).array()
		})
...
export const AlphaDiversityOptionalDefaultsSchema = AlphaDiversitySchema.merge(
	z.object({
		id: z.number().int().optional(),
...
export const AlphaDiversityWithRelationsSchema: z.ZodType<AlphaDiversityWithRelations> = AlphaDiversitySchema.merge(
	z.object({
...
export type AlphaDiversityOptionalDefaultsWithRelations = z.infer<typeof AlphaDiversityOptionalDefaultsSchema> &
	AlphaDiversityOptionalDefaultsRelations;

export const AlphaDiversityOptionalDefaultsWithRelationsSchema: z.ZodType<AlphaDiversityOptionalDefaultsWithRelations> =
	AlphaDiversityOptionalDefaultsSchema.merge(
		z.object({
...
export type AlphaDiversityPartialWithRelations = z.infer<typeof AlphaDiversityPartialSchema> &
	AlphaDiversityPartialRelations;

export const AlphaDiversityPartialWithRelationsSchema: z.ZodType<AlphaDiversityPartialWithRelations> =
	AlphaDiversityPartialSchema.merge(
		z.object({
			AlphaDiversityIndexes: z.lazy(() => AlphaDiversityIndexPartialWithRelationsSchema).array()
		})
	).partial();

export type AlphaDiversityOptionalDefaultsWithPartialRelations = z.infer<typeof AlphaDiversityOptionalDefaultsSchema> &
	AlphaDiversityPartialRelations;

export const AlphaDiversityOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AlphaDiversityOptionalDefaultsWithPartialRelations> =
	AlphaDiversityOptionalDefaultsSchema.merge(
		z
			.object({
				AlphaDiversityIndexes: z.lazy(() => AlphaDiversityIndexPartialWithRelationsSchema).array()
...
export const AlphaDiversityWithPartialRelationsSchema: z.ZodType<AlphaDiversityWithPartialRelations> =
	AlphaDiversitySchema.merge(
		z
			.object({
				AlphaDiversityIndexes: z.lazy(() => AlphaDiversityIndexPartialWithRelationsSchema).array()
			})
...
export const AlphaDiversityIndexOptionalDefaultsSchema = AlphaDiversityIndexSchema.merge(
	z.object({
		id: z.number().int().optional()
	})
);
...
export const AlphaDiversityIndexWithRelationsSchema: z.ZodType<AlphaDiversityIndexWithRelations> =
	AlphaDiversityIndexSchema.merge(
		z.object({
			Library: z.lazy(() => LibraryWithRelationsSchema),
...
export type AlphaDiversityIndexOptionalDefaultsWithRelations = z.infer<
	typeof AlphaDiversityIndexOptionalDefaultsSchema
> &
	AlphaDiversityIndexOptionalDefaultsRelations;

export const AlphaDiversityIndexOptionalDefaultsWithRelationsSchema: z.ZodType<AlphaDiversityIndexOptionalDefaultsWithRelations> =
	AlphaDiversityIndexOptionalDefaultsSchema.merge(
		z.object({
			Library: z.lazy(() => LibraryOptionalDefaultsWithRelationsSchema),
...
export type AlphaDiversityIndexPartialWithRelations = z.infer<typeof AlphaDiversityIndexPartialSchema> &
	AlphaDiversityIndexPartialRelations;

export const AlphaDiversityIndexPartialWithRelationsSchema: z.ZodType<AlphaDiversityIndexPartialWithRelations> =
	AlphaDiversityIndexPartialSchema.merge(
		z.object({
			Library: z.lazy(() => LibraryPartialWithRelationsSchema),
...
export type AlphaDiversityIndexOptionalDefaultsWithPartialRelations = z.infer<
	typeof AlphaDiversityIndexOptionalDefaultsSchema
> &
	AlphaDiversityIndexPartialRelations;

export const AlphaDiversityIndexOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AlphaDiversityIndexOptionalDefaultsWithPartialRelations> =
	AlphaDiversityIndexOptionalDefaultsSchema.merge(
		z
			.object({
				Library: z.lazy(() => LibraryPartialWithRelationsSchema),
...
export type AlphaDiversityIndexWithPartialRelations = z.infer<typeof AlphaDiversityIndexSchema> &
	AlphaDiversityIndexPartialRelations;

export const AlphaDiversityIndexWithPartialRelationsSchema: z.ZodType<AlphaDiversityIndexWithPartialRelations> =
	AlphaDiversityIndexSchema.merge(
		z
			.object({
				Library: z.lazy(() => LibraryPartialWithRelationsSchema),
...
export const ProjectWithRelationsSchema: z.ZodType<ProjectWithRelations> = ProjectSchema.merge(
	z.object({
...
export type ProjectOptionalDefaultsWithRelations = Omit<
	z.infer<typeof ProjectOptionalDefaultsSchema>,
	"userDefined" | "editHistory"
> & {
	userDefined?: JsonValueType | null;
	editHistory?: JsonValueType | null;
} & ProjectOptionalDefaultsRelations;

export const ProjectOptionalDefaultsWithRelationsSchema: z.ZodType<ProjectOptionalDefaultsWithRelations> =
	ProjectOptionalDefaultsSchema.merge(
		z.object({
...
export const ProjectPartialWithRelationsSchema: z.ZodType<ProjectPartialWithRelations> = ProjectPartialSchema.merge(
	z.object({
...
export type ProjectOptionalDefaultsWithPartialRelations = Omit<
	z.infer<typeof ProjectOptionalDefaultsSchema>,
	"userDefined" | "editHistory"
> & {
	userDefined?: JsonValueType | null;
...
export const ProjectOptionalDefaultsWithPartialRelationsSchema: z.ZodType<ProjectOptionalDefaultsWithPartialRelations> =
	ProjectOptionalDefaultsSchema.merge(
		z
			.object({
				Samples: z.lazy(() => SamplePartialWithRelationsSchema).array(),
...
export const ProjectWithPartialRelationsSchema: z.ZodType<ProjectWithPartialRelations> = ProjectSchema.merge(
	z
		.object({
			Samples: z.lazy(() => SamplePartialWithRelationsSchema).array(),
			AssayPreps: z.lazy(() => AssayPrepPartialWithRelationsSchema).array(),
...
export const SamplePartialWithRelationsSchema: z.ZodType<SamplePartialWithRelations> = SamplePartialSchema.merge(
	z.object({
		Project: z.lazy(() => ProjectPartialWithRelationsSchema),
...
export type SampleOptionalDefaultsWithPartialRelations = Omit<
	z.infer<typeof SampleOptionalDefaultsSchema>,
	"userDefined"
> & {
	userDefined?: JsonValueType | null;
} & SamplePartialRelations;
...
export const SampleWithPartialRelationsSchema: z.ZodType<SampleWithPartialRelations> = SampleSchema.merge(
	z
		.object({
			Project: z.lazy(() => ProjectPartialWithRelationsSchema),
			Assays: z.lazy(() => AssayPartialWithRelationsSchema).array(),
...
export const AssayWithRelationsSchema: z.ZodType<AssayWithRelations> = AssaySchema.merge(
	z.object({
		Samples: z.lazy(() => SampleWithRelationsSchema).array(),
		AssayPreps: z.lazy(() => AssayPrepWithRelationsSchema).array(),
		Libraries: z.lazy(() => LibraryWithRelationsSchema).array(),
...
export type AssayOptionalDefaultsWithRelations = z.infer<typeof AssayOptionalDefaultsSchema> &
	AssayOptionalDefaultsRelations;

export const AssayOptionalDefaultsWithRelationsSchema: z.ZodType<AssayOptionalDefaultsWithRelations> =
	AssayOptionalDefaultsSchema.merge(
		z.object({
			Samples: z.lazy(() => SampleOptionalDefaultsWithRelationsSchema).array(),
			AssayPreps: z.lazy(() => AssayPrepOptionalDefaultsWithRelationsSchema).array(),
			Libraries: z.lazy(() => LibraryOptionalDefaultsWithRelationsSchema).array(),
...
export const AssayPartialWithRelationsSchema: z.ZodType<AssayPartialWithRelations> = AssayPartialSchema.merge(
	z.object({
		Samples: z.lazy(() => SamplePartialWithRelationsSchema).array(),
		AssayPreps: z.lazy(() => AssayPrepPartialWithRelationsSchema).array(),
		Libraries: z.lazy(() => LibraryPartialWithRelationsSchema).array(),
...
export type AssayOptionalDefaultsWithPartialRelations = z.infer<typeof AssayOptionalDefaultsSchema> &
	AssayPartialRelations;

export const AssayOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AssayOptionalDefaultsWithPartialRelations> =
	AssayOptionalDefaultsSchema.merge(
		z
			.object({
				Samples: z.lazy(() => SamplePartialWithRelationsSchema).array(),
...
export const AssayWithPartialRelationsSchema: z.ZodType<AssayWithPartialRelations> = AssaySchema.merge(
	z
		.object({
			Samples: z.lazy(() => SamplePartialWithRelationsSchema).array(),
			AssayPreps: z.lazy(() => AssayPrepPartialWithRelationsSchema).array(),
...
export const AssayPrepOptionalDefaultsSchema = AssayPrepSchema.merge(
	z.object({
		id: z.number().int().optional()
	})
);
...
export const AssayPrepWithRelationsSchema: z.ZodType<AssayPrepWithRelations> = AssayPrepSchema.merge(
	z.object({
		Project: z.lazy(() => ProjectWithRelationsSchema),
		Assay: z.lazy(() => AssayWithRelationsSchema),
		Libraries: z.lazy(() => LibraryWithRelationsSchema).array()
...
export type AssayPrepOptionalDefaultsWithRelations = z.infer<typeof AssayPrepOptionalDefaultsSchema> &
	AssayPrepOptionalDefaultsRelations;

export const AssayPrepOptionalDefaultsWithRelationsSchema: z.ZodType<AssayPrepOptionalDefaultsWithRelations> =
	AssayPrepOptionalDefaultsSchema.merge(
		z.object({
			Project: z.lazy(() => ProjectOptionalDefaultsWithRelationsSchema),
			Assay: z.lazy(() => AssayOptionalDefaultsWithRelationsSchema),
			Libraries: z.lazy(() => LibraryOptionalDefaultsWithRelationsSchema).array()
...
export const AssayPrepPartialWithRelationsSchema: z.ZodType<AssayPrepPartialWithRelations> =
	AssayPrepPartialSchema.merge(
		z.object({
			Project: z.lazy(() => ProjectPartialWithRelationsSchema),
			Assay: z.lazy(() => AssayPartialWithRelationsSchema),
			Libraries: z.lazy(() => LibraryPartialWithRelationsSchema).array()
...
export type AssayPrepOptionalDefaultsWithPartialRelations = z.infer<typeof AssayPrepOptionalDefaultsSchema> &
	AssayPrepPartialRelations;

export const AssayPrepOptionalDefaultsWithPartialRelationsSchema: z.ZodType<AssayPrepOptionalDefaultsWithPartialRelations> =
	AssayPrepOptionalDefaultsSchema.merge(
		z
			.object({
				Project: z.lazy(() => ProjectPartialWithRelationsSchema),
...
export const AssayPrepWithPartialRelationsSchema: z.ZodType<AssayPrepWithPartialRelations> = AssayPrepSchema.merge(
	z
		.object({
			Project: z.lazy(() => ProjectPartialWithRelationsSchema),
			Assay: z.lazy(() => AssayPartialWithRelationsSchema),
...
export const LibraryWithRelationsSchema: z.ZodType<LibraryWithRelations> = LibrarySchema.merge(
	z.object({
		Project: z.lazy(() => ProjectWithRelationsSchema),
...
export type LibraryOptionalDefaultsWithRelations = Omit<
	z.infer<typeof LibraryOptionalDefaultsSchema>,
	"userDefined"
> & {
	userDefined?: JsonValueType | null;
} & LibraryOptionalDefaultsRelations;

export const LibraryOptionalDefaultsWithRelationsSchema: z.ZodType<LibraryOptionalDefaultsWithRelations> =
	LibraryOptionalDefaultsSchema.merge(
		z.object({
			Project: z.lazy(() => ProjectOptionalDefaultsWithRelationsSchema),
...
export const LibraryPartialWithRelationsSchema: z.ZodType<LibraryPartialWithRelations> = LibraryPartialSchema.merge(
	z.object({
		Project: z.lazy(() => ProjectPartialWithRelationsSchema),
...
export type LibraryOptionalDefaultsWithPartialRelations = Omit<
	z.infer<typeof LibraryOptionalDefaultsSchema>,
	"userDefined"
> & {
	userDefined?: JsonValueType | null;
...
export const LibraryOptionalDefaultsWithPartialRelationsSchema: z.ZodType<LibraryOptionalDefaultsWithPartialRelations> =
	LibraryOptionalDefaultsSchema.merge(
		z
			.object({
				Project: z.lazy(() => ProjectPartialWithRelationsSchema),
...
export const LibraryWithPartialRelationsSchema: z.ZodType<LibraryWithPartialRelations> = LibrarySchema.merge(
	z
		.object({
			Project: z.lazy(() => ProjectPartialWithRelationsSchema),
			Sample: z.lazy(() => SamplePartialWithRelationsSchema),
