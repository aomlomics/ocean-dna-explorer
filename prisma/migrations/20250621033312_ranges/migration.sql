...
-- CUSTOM
ALTER TABLE "Assay.ampliconSize" ALTER COLUMN "ampliconSize" TYPE DOUBLE PRECISION[] USING ARRAY[ampliconSize]::DOUBLE PRECISION[];
ALTER TABLE "Assay" ALTER COLUMN "ampliconSize" SET DEFAULT ARRAY[]::DOUBLE PRECISION[];