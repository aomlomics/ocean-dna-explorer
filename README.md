...
This project builds on a number of open-source libraries. For a full list of dependencies including their licenses and estimated contribution to this project, see [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
